...
4. Crie/Referencie uma nova **branch** e nomeie como `feat/community/RonielsonAndrade28`:'git checkout -b feat/community/RonielsonAndrade28'
    > Exemplo: 'git checkout -b feat/community/RonielsonAndrade28'
5. Dentro da pasta [`community`](https://github.com/digitalinnovationone/dio-lab-open-source/tree/main/community), crie um arquivo em Markdown (extensão `.md`) e nomeie com o mesmo nome do seu usuário no GitHub;
    > Exemplo: `RonielsonAndrade28.md` <br>
